...
interface ManagerRegisterProps {
  admin?: AdminListDto;
  open?: boolean;
...
const ManagerRegisterPopup: FC<ManagerRegisterProps> = (props) => {
  ...
  const watchAllFields = watch(); // 모든 필드의 값을 감시
  const phoneValue = watch("phone"); // 전화번호 필드 감시
